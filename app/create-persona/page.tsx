...
import type { Persona, Question } from "@/types/persona"
...
const STEPS = [
  ...
  { id: 3, title: "Questions & Answers", description: "Add conversation starters" },
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label className="text-sm font-medium text-gray-500">Accent</Label>
                <p>{formData.accent}</p>
              </div>
              <div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Follow the steps to create your custom persona</p>
          </div>
              ...
              >
                <div
                  className={`w-8 h-8 rounded-full mx-auto mb-2 flex items-center justify-center text-sm font-medium ${
                    step.id <= currentStep ? "bg-purple-600 text-white" : "bg-gray-200 text-gray-400"
                  }`}
                >
                  {step.id}
                </div>
